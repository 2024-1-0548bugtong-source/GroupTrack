...
export default function ProjectPage() {
  ...
  const statusData = [
    ...
    { name: 'Submitted for Review', value: tasks.filter(t => normalizeTaskStatus(t.status) === 'submitted').length, color: '#2563eb' },
    { name: 'Approved (Completed)', value: tasks.filter(t => normalizeTaskStatus(t.status) === 'completed').length, color: '#16a34a' },
  ];
