...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const extensionBuildStamp = import.meta.env.VITE_BUILD_STAMP as string | undefined;
