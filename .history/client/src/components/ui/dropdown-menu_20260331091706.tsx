...
>(({ className, sideOffset = 4, ...props }, ref) => {
  const content = (
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        isExtension ? "max-h-72" : "max-h-[var(--radix-dropdown-menu-content-available-height)]",
        className
      )}
      {...props}
    />
  ...
  // In extension mode, skip portal and render inline; Radix will handle positioning
  if (isExtension) {
    return content
  }
