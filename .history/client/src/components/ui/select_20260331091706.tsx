...
const SelectExtension = ({ 
  ...
  return (
    <SelectContext.Provider value={{ value, onValueChange }}>
      <div className="relative w-full" onBlur={() => setIsOpen(false)} tabIndex={-1}>
        <div 
        ...
        >
          <span className="line-clamp-1">
            {children && typeof children === 'object' && React.isValidElement(children) ? children : value}
          </span>
...
const Select = isExtension ? SelectExtension : SelectPrimitive.Root
