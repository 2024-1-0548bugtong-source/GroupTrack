...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 relative overflow-hidden">
      {/* Background Decor - Animated mesh */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-pink-200/40 dark:bg-pink-950/20 rounded-full blur-3xl animate-pulse-soft" style={{animationDuration: '6s'}} />
        <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] bg-fuchsia-200/40 dark:bg-fuchsia-950/20 rounded-full blur-3xl animate-pulse-soft" style={{animationDuration: '8s', animationDelay: '2s'}} />
        <div className="absolute top-[30%] left-[50%] w-[300px] h-[300px] bg-purple-200/30 dark:bg-purple-950/15 rounded-full blur-3xl animate-pulse-soft" style={{animationDuration: '7s', animationDelay: '1s'}} />
      </div>

      <Card className="w-full max-w-md border border-border/50 shadow-2xl bg-card/90 backdrop-blur-xl relative z-10 animate-fade-in-up overflow-hidden">
        {/* Top accent stripe */}
        <div className="gradient-stripe h-1 w-full" />
        
        <CardHeader className="text-center space-y-3 pb-4 pt-8">
          <div className="mx-auto w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center mb-1">
            <GraduationCap className="h-7 w-7 text-primary" />
          </div>
          <div className="space-y-1.5">
            <CardTitle className="text-2xl font-display font-bold tracking-tight gradient-text">
              GroupTrack
            </CardTitle>
