...
export function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans text-foreground">
      ...
      {/* Navigation */}
      <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur-lg supports-[backdrop-filter]:bg-background/60 border-b border-border/50">
            ...
            {user && (
              <>
                ...
                <div className="hidden md:flex items-center gap-2.5 mr-1">
                  ...
                  <span className="text-sm font-medium">{nickname || "Guest"}</span>
                </div>
      ...
      {/* Main Content */}
      <main className="flex-1 container py-8 md:py-10 px-4 md:px-8 mx-auto max-w-7xl">
        {children}
      </main>
