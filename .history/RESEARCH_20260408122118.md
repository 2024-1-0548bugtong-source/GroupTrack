...
This chapter presents the outcomes of the design, development, and refinement of GroupTrack based on the Rapid Application Development (RAD) methodology. The results are organized according to the methodology phases: gathered requirements, system design outputs, implementation, deployment, and testing.
...
1. Year level distribution: Third Year (3), Fourth Year (2), Second Year (1).
2. Group-work exposure: Often (5), Very Often (1).
...
1. Unequal participation occurs in group projects: 4.50/5.
2. Tracking individual contributions is difficult: 4.00/5.
3. Responsibilities are often unclear among members: 4.33/5.
4. Group conflicts happen due to unclear task assignments: 4.17/5.
5. It is difficult to prove individual contributions to instructors: 4.33/5.
6. Existing tools are insufficient for tracking contributions: 3.83/5.
...
1. Task assignment tracking: 4.00/5.
2. Role-based membership: 4.33/5.
3. Deadline notifications: 3.67/5.
4. Project join codes: 4.50/5.
5. Progress dashboard: 4.33/5.
6. Contribution history: 4.50/5.
...
Final deployment validation should include:
...
3.5.4 User Evaluation (SUS)

User inspection was performed using guided core tasks and a System Usability Scale (SUS) questionnaire distributed through Google Forms.

For this dataset, 6 respondents completed the usability rating items. The composite usability rating across 12 post-use items was 4.29/5, equivalent to 85.8% of the maximum score.

Interpretation: The system demonstrates high perceived usability and acceptability for classroom use.
...
The results demonstrate that GroupTrack successfully implemented the targeted features identified during requirements gathering and design. Through RAD-based iterative development, the project delivered a functional system that addresses key academic group-work issues, including uneven participation, unclear responsibility, and limited visibility of individual outputs.
